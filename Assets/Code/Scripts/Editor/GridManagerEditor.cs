...
namespace Code.Scripts.Editor
{
    ...
    public class GridManagerEditor : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var structuresProp = serializedObject.FindProperty("m_structures");
            var environmentProp = serializedObject.FindProperty("m_environment");
            ...
            var structuresField = new PropertyField(structuresProp);
            structuresField.BindProperty(structuresProp);
            var environmentField = new PropertyField(environmentProp);
            environmentField.BindProperty(environmentProp);
